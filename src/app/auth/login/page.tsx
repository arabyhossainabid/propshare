  ...
  const handleGoogleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      ...
      try {
        ...
        // Send user data to our backend social login endpoint
          ...
          <div className='p-8 md:p-10 shadow-3xl h-full flex flex-col justify-center'>
            ...
            <div className='auth-field space-y-3 mb-8'>
              <Button
                ...
                className='w-full bg-background hover:bg-muted text-foreground border border-border rounded-xl py-6 flex items-center justify-center gap-3 transition-all h-12 group shadow-sm disabled:opacity-50'
              >
                {isGoogleLoading ? (
