...
export default function PaymentPage() {
    ...
    if (isComplete) {
        return (
            <div ref={pageRef} className="min-h-screen bg-[#0a0f1d] flex items-center justify-center p-6 relative overflow-hidden">
                    ...
                    <div className="payment-left lg:col-span-3 space-y-6">
                        ...
                        <div className="bg-white/[0.02] border border-white/5 rounded-3xl p-8">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between">
                                    <span className="text-sm text-white/40">Number of Shares</span>
                                    <span className="text-sm text-white/40">
                                        Available: <span className="text-white font-medium">{property.availableShares}</span>
                                    </span>
                                </div>
                                ...
                                <div className="flex gap-2">
                                    {[5, 10, 25, 50].map((amount) => (
                                        <button
                                            key={amount}
                                            onClick={() => setShares(Math.min(property.availableShares, amount))}
                        ...
                        <div className="bg-white/[0.02] border border-white/5 rounded-3xl p-8">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
                                ...
                                ] as { id: PaymentMethod; icon: React.ElementType; label: string }[]).map(
                                    (method) => {
                                ...
                                {paymentMethod === "bkash" && (
                                    <div className="space-y-4">
                                        <div className="bg-rose-500/5 border border-rose-500/10 rounded-2xl p-5 text-center space-y-3">
                                            ...
                                            <h4 className="text-base font-bold text-white">Pay with bKash</h4>
                                ...
                                {paymentMethod === "nagad" && (
                                    <div className="space-y-4">
                                        <div className="bg-amber-500/5 border border-amber-500/10 rounded-2xl p-5 text-center space-y-3">
                                            ...
                                            <h4 className="text-base font-bold text-white">Pay with Nagad</h4>
                                            <p className="text-xs text-white/40">
                                    ...
                                    <div className="space-y-4">
                                        <div className="bg-blue-500/5 border border-blue-500/10 rounded-2xl p-5 space-y-3">
                                            <div className="flex items-center gap-3 mb-2">
                                                ...
                                                <div>
                                                    <h4 className="text-sm font-bold text-white">Bank Transfer</h4>
                                                    <p className="text-xs text-white/40">Transfer to our bank account</p>
                                                </div>
                                            </div>
                                            <div className="space-y-2 text-sm">
                                                <div className="flex justify-between">
                                                    <span className="text-white/40">Bank Name</span>
                                                    <span className="text-white font-mono">Dutch-Bangla Bank</span>
                                                </div>
                                                <div className="flex justify-between">
                                                    <span className="text-white/40">Account No</span>
                                                    <span className="text-white font-mono">1234 5678 9012</span>
                                                </div>
                                                <div className="flex justify-between">
                                                    <span className="text-white/40">Branch</span>
                                                    <span className="text-white font-mono">Gulshan, Dhaka</span>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="bg-white/[0.02] border border-white/5 rounded-3xl p-8 sticky top-28 space-y-6">
                            ...
                            <div className="bg-emerald-500/5 border border-emerald-500/10 rounded-2xl p-4 space-y-2">
                                ...
                                <p className="text-xs text-white/30">
                                    Est. monthly income: ৳
                                    {Math.round(
                                        (totalAmount * parseFloat(property.expectedReturn)) / 100 / 12
                                    ).toLocaleString()}
                                </p>
                            </div>
