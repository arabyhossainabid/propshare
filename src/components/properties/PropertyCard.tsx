          ...
          <div className='flex-1 p-6 flex flex-col justify-between gap-4'>
            ...
            <div className='flex flex-wrap items-center gap-6'>
              ...
              <div className='ml-auto'>
                <Button className='bg-white/5 hover:bg-white/10 text-white hover:text-white rounded-xl transition-all duration-300'>
                  Invest Now
    ...
    >
      <div className='bg-card rounded-3xl border border-white/5 overflow-hidden hover:border-white/10 hover:shadow-2xl hover:shadow-blue-900/10 transition-all duration-700 h-full'>
        ...
        <div className='p-6 space-y-4'>
          ...
          <Button className='w-full bg-white/5 hover:bg-white/10 text-white hover:text-white rounded-xl py-5 transition-all duration-300 group/btn'>
            Invest Now
